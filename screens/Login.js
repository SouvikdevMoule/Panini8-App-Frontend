  ...
  const navigation = useNavigation();
    return (
      <ImageBackground
            ...
            >
              <View className="flex-1 justify-center items-center  h-fit">
              <View className="gap-2 w-[90%] justify-center items-center bg-white py-4 rounded-lg shadow-xl h-auto">
