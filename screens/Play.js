      ...
      <View className="flex gap-6 items-center p-4">
        ...
        {showQuestionCard ? (
          ...
          <View className="w-[80%] bg-white shadow-lg rounded-lg p-4 items-center">
            <Text className="font-bold text-lg mb-2">{cards[currentIndex].question}</Text>
            <Text className="font-semibold text-sm mb-4">Select any option</Text>
          ...
          <View className="w-[80%] bg-white shadow-lg rounded-lg p-4 items-center">
            ...
            <View className="items-center">
              <Text className="text-gray-800 font-medium">Module: Algebra II</Text>
              <Text className="text-gray-800 font-medium">Difficulty: Medium</Text>
              <Text className="text-green-600 font-medium mt-2">Points: 0.00</Text>
            </View>
          </View>
        )}
      </View>
      ...
      >
        <View className="flex-1 justify-center items-center bg-black/50">
          <View className="w-[80%] bg-white rounded-lg p-6 shadow-lg">
            ...
            <Text className="text-gray-800 mb-4">{cards[currentIndex].hint}</Text>
            <TouchableOpacity
