    ...
    <View>
      {loading ? (
        ...
        contests.map((contest) => (
          <View
            key={contest._id}
            className="bg-white rounded-lg overflow-hidden m-4 shadow-md"
          >
            {/* Header Image */}
            ...
            >
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.push("Dash", { contestName: contest.name })
                }
              >
            ...
            <View className="flex-row flex-wrap justify-around p-4">
              <TouchableOpacity
                className="bg-gray-100 rounded-lg py-2 px-3 my-1 flex-row items-center w-[45%]"
